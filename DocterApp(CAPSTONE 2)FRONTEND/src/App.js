...
function App() {
  return (
    ...
    <div className="container">
      ...
      <BrowserRouter>
      <nav className="btn btn-info bg-gradient navbar navbar-expand-lg navheader">
      <a className="navbar-brand" href="#">CliNiQ<svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-heart-pulse-fill" viewBox="0 0 16 16">
      ...
      <div className="collapse navbar-collapse">
          <ul className="navbar-nav">
            <li className="nav-item">
              <Link className="nav-link active" to="/adddoctor">Add Doctor</Link>
            </li>
            <li className="nav-item">
              <Link  className="nav-link active" to="/doctorlist">Doctor List</Link>
            </li>
          </ul>
        </div>
      </nav>
